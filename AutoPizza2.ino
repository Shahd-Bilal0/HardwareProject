...
NexTouch *nex_listen_list[] ={
  &b0,&b1,&p,&v,&s,&c,&back,&confim,&next, NULL
};

void b0_press(void *ptr) {
  Serial.println("Order Now");
    //Serial2.print("page1.10.vis=0");
    Serial2.print("vis 10,0");
 Serial2.write(0xff);
 Serial2.write(0xff);
 Serial2.write(0xff);
...
void startmoving (){
  ...
  //Serial2.print("page3.b0.vis=0");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);
    
 
// Serial.print("page0.cb0.tsw=0");
  ...
  digitalWrite(enPin1,HIGH); 
    Serial2.print("page3.b0.vis=1");  // Set visibility to 0 (hidden)
    Serial2.write(0xff);
   Serial2.write(0xff);
    Serial2.write(0xff);
   for(int x = 0; x < 180; x++)
...
//  digitalWrite(enPin4,HIGH); 
//
//   Serial2.print("page0.b0.vis=1");  // Set visibility to 0 (hidden)
//    Serial2.write(0xff);
//    Serial2.write(0xff);
//    Serial2.write(0xff);
}
...
//********************************************************************//
  ...
  //   if(sens==1)
  //   Serial2.print("page3.p.tsw=0");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);
  //    if(sens==2)
  //   Serial2.print("page3.p.tsw=1");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);

  //   if(sens==3)
  //   Serial2.print("page1.v.tsw=0");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);
  //   if(sens==4)
  //   Serial2.print("page1.v.tsw=1");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);

  //   if(sens==5)
  //   Serial2.print("page1.s.tsw=0");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);
  //    if(sens==6)
  //   Serial2.print("page1.s.tsw=1");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);

  //   if(sens==7)
  //   Serial2.print("page1.c.tsw=0");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);
  //    if(sens==8)
  //   Serial2.print("page1.c.tsw=1");  // Set visibility to 0 (hidden)
  // Serial2.write(0xff);
  //  Serial2.write(0xff);
  //   Serial2.write(0xff);
}
